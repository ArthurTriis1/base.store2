...
- Adds vtex search tracking script. With this we will populate TopSearches and Autocomplete indices
- VTEX search tracking script. With this, we will populate TopSearches and Autocomplete indices
